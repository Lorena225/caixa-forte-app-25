    ...
    Tables: {
      ...
      budget_forecasts: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "budget_forecasts_cost_center_id_fkey"
      ...
      compras: {
        ...
        Relationships: [
          {
            foreignKeyName: "compras_condicao_pagamento_id_fkey"
            columns: ["condicao_pagamento_id"]
            isOneToOne: false
            referencedRelation: "condicoes_pagamento"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "compras_cotacao_id_fkey"
            columns: ["cotacao_id"]
            isOneToOne: false
          ...
          },
          {
            ...
            columns: ["fornecedor_id"]
            isOneToOne: false
            referencedRelation: "v_fornecedores_performance"
            referencedColumns: ["fornecedor_id"]
          },
          {
            foreignKeyName: "compras_pedido_compra_id_fkey"
          ...
          },
          {
            ...
            columns: ["pedido_compra_id"]
            isOneToOne: false
            referencedRelation: "v_pedidos_pendentes"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      cotacoes: {
        Row: {
          ...
          updated_at: string | null
          vencedor_cotacao_fornecedor_id: string | null
      ...
      cotacoes_fornecedores: {
        ...
        Relationships: [
          {
            foreignKeyName: "cotacoes_fornecedores_condicao_pagamento_id_fkey"
            columns: ["condicao_pagamento_id"]
            isOneToOne: false
            referencedRelation: "condicoes_pagamento"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "cotacoes_fornecedores_cotacao_item_id_fkey"
      ...
      departments: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "departments_organizational_unit_id_fkey"
            columns: ["organizational_unit_id"]
            isOneToOne: false
            referencedRelation: "organizational_units"
            referencedColumns: ["id"]
      ...
      estoque: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "estoque_produto_variacao_id_fkey"
      ...
      inventarios_itens: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "inventarios_itens_inventario_id_fkey"
          ...
          {
            foreignKeyName: "inventarios_itens_produto_id_fkey"
            columns: ["produto_id"]
            isOneToOne: false
            referencedRelation: "produtos"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "inventarios_itens_produto_variacao_id_fkey"
            columns: ["produto_variacao_id"]
            isOneToOne: false
            referencedRelation: "produtos_variacoes"
            referencedColumns: ["id"]
      ...
      movimentacoes_estoque: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "movimentacoes_estoque_produto_variacao_id_fkey"
            columns: ["produto_variacao_id"]
            isOneToOne: false
            referencedRelation: "produtos_variacoes"
            referencedColumns: ["id"]
      ...
      parametros_fiscais: {
        ...
        Relationships: [
          {
            foreignKeyName: "parametros_fiscais_certificado_digital_id_fkey"
            columns: ["certificado_digital_id"]
            isOneToOne: false
      ...
      pedidos_compra: {
        ...
        Relationships: [
          {
            foreignKeyName: "pedidos_compra_condicao_pagamento_id_fkey"
            columns: ["condicao_pagamento_id"]
            isOneToOne: false
            referencedRelation: "condicoes_pagamento"
            referencedColumns: ["id"]
      ...
      recebimentos_compra: {
        Row: {
          ...
          id: string
          numero_recebimento: string | null
          observacoes: string | null
    ...
    Views: {
      ...
      v_budget_master_analysis: {
        Row: {
          ...
          status: string | null
          total_expense_planned: number | null
          total_profit_planned: number | null
          total_revenue_planned: number | null
          version: number | null
          year: number | null
        }
        Relationships: [
      ...
      v_pedidos_pendentes: {
        Row: {
          ...
          total_quantidade_pedida: number | null
          total_quantidade_pendente: number | null
          total_quantidade_recebida: number | null
          valor_total: number | null
        }
        Relationships: [
          {
      ...
      v_produtos_giro_estoque: {
        Row: {
          ...
          quantidade_atual: number | null
          total_entradas_12m: number | null
          total_saidas_12m: number | null
          valor_total_estoque: number | null
        }
        Relationships: [
          {
    ...
    Functions: {
      ...
      gerar_chave_acesso_nfe: {
        Args: {
          p_ano_mes: string
          p_cnpj: string
          p_codigo_numerico?: number
          p_modelo: string
          p_numero: number
          p_serie: string
          p_tipo_emissao?: number
          p_uf: string
        }
        Returns: string
      }
      gerar_proximo_numero_nfe: {
      ...
      validar_xml_nfe: { Args: { p_xml: string }; Returns: Json }
