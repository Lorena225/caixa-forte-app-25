...
export const counterpartiesTemplate: DefaultTemplate = {
  ...
  columns: [
    ...
    { name: 'is_client', label: 'Cliente', type: 'boolean', required: false, default: true },
    { name: 'is_supplier', label: 'Fornecedor', type: 'boolean', required: false, default: false },
    { name: 'person_type', label: 'Tipo Pessoa', type: 'enum', required: false, options: ['pf', 'pj'], default: 'pj' },
    { name: 'document', label: 'CPF/CNPJ', type: 'text', required: false },
    { name: 'legal_name', label: 'Razão Social', type: 'text', required: false },
    { name: 'email', label: 'E-mail', type: 'text', required: false },
    { name: 'phone', label: 'Telefone', type: 'text', required: true },
    { name: 'address_street', label: 'Endereço', type: 'text', required: false },
    { name: 'address_city', label: 'Cidade', type: 'text', required: false },
    { name: 'address_state', label: 'UF', type: 'text', required: false },
    { name: 'address_zip', label: 'CEP', type: 'text', required: false },
    { name: 'is_active', label: 'Ativo', type: 'boolean', required: false, default: true },
    { name: 'external_key', label: 'Chave Externa', type: 'text', required: false },
  ],
  sampleData: [
    { name: 'Empresa ABC Ltda', is_client: 'Sim', is_supplier: 'Não', person_type: 'pj', document: '12.345.678/0001-90', email: 'contato@abc.com', phone: '(11) 99999-9999', is_active: 'Sim' },
    { name: 'Fornecedor XYZ', is_client: 'Não', is_supplier: 'Sim', person_type: 'pj', document: '98.765.432/0001-10', email: 'financeiro@xyz.com', phone: '(11) 88888-8888', is_active: 'Sim' },
    { name: 'Parceiro Completo', is_client: 'Sim', is_supplier: 'Sim', person_type: 'pj', document: '11.222.333/0001-44', email: 'contato@parceiro.com', phone: '(11) 77777-7777', is_active: 'Sim' },
  ],
  instructions: [
    'O CPF/CNPJ pode ser informado com ou sem formatação',
    'Marque "Sim" em Cliente e/ou Fornecedor conforme o papel do parceiro',
    'Pelo menos um papel (Cliente ou Fornecedor) deve ser marcado',
    'Telefone é obrigatório para cadastro rápido',
  ],
};
