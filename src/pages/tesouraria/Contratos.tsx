                    ...
                    {filteredContracts.map((contract) => (
                      ...
                      >
                        ...
                        <TableCell className="text-center">
                          <Badge variant="outline">{contract.amortization_system}</Badge>
                        </TableCell>
                        <TableCell className="text-center">
              ...
              <CardContent className="pt-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold">{contracts.filter(c => c.status === 'ATIVO').length}</p>
                  </div>
              ...
              <CardContent className="pt-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold">{contracts.filter(c => c.status === 'EDICAO').length}</p>
                  </div>
