...
export default function BaixaManualAR() {
  ...
  const [settlementType, setSettlementType] = useState<SettlementType>('RECEBIMENTO');
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      {step === 'filters' && (
        <Card>
          <CardHeader>
            <CardTitle>Filtrar Títulos a Receber</CardTitle>
