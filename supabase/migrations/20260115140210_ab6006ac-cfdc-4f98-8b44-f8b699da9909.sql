...
('make', 'Make (Integromat)', 'Automatize fluxos com Make', 'Use o Make para criar automações complexas conectando o Vitrio a centenas de outros apps.', 'automation', ARRAY['Triggers personalizados', 'Actions completas', 'Webhooks', 'Templates prontos'], 'freemium', true),
